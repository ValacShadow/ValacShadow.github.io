...
<div class="topnav">
  ...
  <form action="logout.php">
   <a id="siu"  href="logout.php" <button style="width:auto;">Logout</button></a>   
	...
	<a id="siu" href="#xyz"><?php echo $_SESSION['username'];?></a>
</div>
<br>
...
<div class="mySlides fade">
 ...
 <a href="a href="https://www.imdb.com/title/tt4154796/" target="_blank" "> <img src="endgame.jpg" width="1500" height="600"></a>
...
<br>
<a href="theatre.php"><img src="endgame.jpg" alt="endgame" style="width:400px;height:400px;padding:30px"></a>
<a href="pacificrim.php"><img src="pacificrim.jpg" alt="endgame" style="width:400px;height:400px;padding:30px"></a >
<a href="uri.php"><img src="uri.jpg" alt="uri" style="width:400px;height:400px;padding:30px"></a>
